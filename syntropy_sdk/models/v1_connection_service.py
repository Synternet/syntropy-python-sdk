...
class V1ConnectionService(object):
    ...
    def __init__(self, agent_connection_group_id=None, agent_connection_subnets=None, agent_2=None, agent_1=None):  # noqa: E501
    ...
    def agent_connection_subnets(self, agent_connection_subnets):
        ...
        if agent_connection_subnets is None:
            raise ValueError("Invalid value for `agent_connection_subnets`, must not be `None`")  # noqa: E501
