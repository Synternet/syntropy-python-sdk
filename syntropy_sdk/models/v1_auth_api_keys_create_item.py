...
class V1AuthApiKeysCreateItem(object):
    ...
    def __init__(self, api_key_name=None, api_key_description=None, api_key_valid_until=None, api_key_allowed_tag_names=None, api_key_secret=None, user_id=None, api_key_id=None, api_key_created_at=None, api_key_updated_at=None):  # noqa: E501
    ...
    def api_key_secret(self, api_key_secret):
        ...
        if api_key_secret is None:
            raise ValueError("Invalid value for `api_key_secret`, must not be `None`")  # noqa: E501
