...
class AgentLockedFields(object):
    ...
    def __init__(self, agent_location_country=None, agent_location_city=None, agent_location_lat=None, agent_location_lon=None, agent_provider_name=None, agent_tags=None, agent_name=None):  # noqa: E501
