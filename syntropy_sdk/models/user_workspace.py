...
class UserWorkspace(object):
    ...
    def __init__(self, user_id=None, workspace_id=None, role_id=None, user_workspace_id=None, user_workspace_created_at=None, user_workspace_updated_at=None, user=None, workspace=None, role=None):  # noqa: E501
    ...
    def user_workspace_id(self, user_workspace_id):
        ...
        if user_workspace_id is None:
            raise ValueError("Invalid value for `user_workspace_id`, must not be `None`")  # noqa: E501
    ...
    def user_workspace_created_at(self, user_workspace_created_at):
        ...
        if user_workspace_created_at is None:
            raise ValueError("Invalid value for `user_workspace_created_at`, must not be `None`")  # noqa: E501
    ...
    def user_workspace_updated_at(self, user_workspace_updated_at):
        ...
        if user_workspace_updated_at is None:
            raise ValueError("Invalid value for `user_workspace_updated_at`, must not be `None`")  # noqa: E501
