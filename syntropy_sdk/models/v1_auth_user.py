...
class V1AuthUser(object):
    ...
    def __init__(self, user_id=None, user_email=None, user_settings=None, user_scopes=None):  # noqa: E501
    ...
    def user_scopes(self, user_scopes):
        ...
        if user_scopes is None:
            raise ValueError("Invalid value for `user_scopes`, must not be `None`")  # noqa: E501
