...
class V1ConnectionAgent(object):
    ...
    def __init__(self, agent_is_online=None, agent_status=None, agent_subnets_count=None, agent_is_virtual=None, agent_name=None, agent_public_ipv4=None, agent_id=None, agent_provider_id=None):  # noqa: E501
    ...
    def agent_subnets_count(self, agent_subnets_count):
        ...
        if agent_subnets_count is None:
            raise ValueError("Invalid value for `agent_subnets_count`, must not be `None`")  # noqa: E501
