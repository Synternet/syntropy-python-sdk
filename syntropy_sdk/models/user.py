...
class User(object):
    ...
    def __init__(self, user_email=None, user_password=None, user_id=None, user_created_at=None, user_updated_at=None, user_settings=None, workspace_default_id=None, permissions=None, user_workspaces=None, role=None, default_workspace=None):  # noqa: E501
    ...
    def user_created_at(self, user_created_at):
        ...
        if user_created_at is None:
            raise ValueError("Invalid value for `user_created_at`, must not be `None`")  # noqa: E501
    ...
    def user_updated_at(self, user_updated_at):
        ...
        if user_updated_at is None:
            raise ValueError("Invalid value for `user_updated_at`, must not be `None`")  # noqa: E501
    ...
    def user_workspaces(self, user_workspaces):
        ...
        if user_workspaces is None:
            raise ValueError("Invalid value for `user_workspaces`, must not be `None`")  # noqa: E501
