...
class V1AStatusAgentStatus(object):
    ...
    def __init__(self, iface_active=None, public_last_handshake=None, public_latency=None, public_packet_loss=None, public_status=None, public_warnings=None, sdn1_last_handshake=None, sdn1_latency=None, sdn1_packet_loss=None, sdn1_path=None, sdn1_status=None, sdn1_warnings=None, sdn2_last_handshake=None, sdn2_latency=None, sdn2_packet_loss=None, sdn2_path=None, sdn2_status=None, sdn2_warnings=None, sdn3_last_handshake=None, sdn3_latency=None, sdn3_packet_loss=None, sdn3_path=None, sdn3_status=None, sdn3_warnings=None, status=None, updated_at=None):  # noqa: E501
    ...
    def iface_active(self, iface_active):
        ...
        if iface_active is None:
            raise ValueError("Invalid value for `iface_active`, must not be `None`")  # noqa: E501
    ...
    def public_last_handshake(self, public_last_handshake):
        ...
        if public_last_handshake is None:
            raise ValueError("Invalid value for `public_last_handshake`, must not be `None`")  # noqa: E501
    ...
    def public_latency(self, public_latency):
        ...
        if public_latency is None:
            raise ValueError("Invalid value for `public_latency`, must not be `None`")  # noqa: E501
    ...
    def public_packet_loss(self, public_packet_loss):
        ...
        if public_packet_loss is None:
            raise ValueError("Invalid value for `public_packet_loss`, must not be `None`")  # noqa: E501
    ...
    def public_status(self, public_status):
        ...
        if public_status is None:
            raise ValueError("Invalid value for `public_status`, must not be `None`")  # noqa: E501
    ...
    def public_warnings(self, public_warnings):
        ...
        if public_warnings is None:
            raise ValueError("Invalid value for `public_warnings`, must not be `None`")  # noqa: E501
        allowed_values = ["PACKET_LOSS", "LATENCY", "HANDSHAKE"]  # noqa: E501
        if not set(public_warnings).issubset(set(allowed_values)):
            raise ValueError(
                "Invalid values for `public_warnings` [{0}], must be a subset of [{1}]"  # noqa: E501
                .format(", ".join(map(str, set(public_warnings) - set(allowed_values))),  # noqa: E501
    ...
    def sdn1_last_handshake(self, sdn1_last_handshake):
        ...
        if sdn1_last_handshake is None:
            raise ValueError("Invalid value for `sdn1_last_handshake`, must not be `None`")  # noqa: E501
    ...
    def sdn1_latency(self, sdn1_latency):
        ...
        if sdn1_latency is None:
            raise ValueError("Invalid value for `sdn1_latency`, must not be `None`")  # noqa: E501
    ...
    def sdn1_packet_loss(self, sdn1_packet_loss):
        ...
        if sdn1_packet_loss is None:
            raise ValueError("Invalid value for `sdn1_packet_loss`, must not be `None`")  # noqa: E501
    ...
    def sdn1_path(self, sdn1_path):
        ...
        if sdn1_path is None:
            raise ValueError("Invalid value for `sdn1_path`, must not be `None`")  # noqa: E501
    ...
    def sdn1_status(self, sdn1_status):
        ...
        if sdn1_status is None:
            raise ValueError("Invalid value for `sdn1_status`, must not be `None`")  # noqa: E501
        allowed_values = ["OK", "WARNING", "ERROR"]  # noqa: E501
        if sdn1_status not in allowed_values:
            raise ValueError(
                "Invalid value for `sdn1_status` ({0}), must be one of {1}"  # noqa: E501
                .format(sdn1_status, allowed_values)
            )
    ...
    def sdn1_warnings(self, sdn1_warnings):
        ...
        if sdn1_warnings is None:
            raise ValueError("Invalid value for `sdn1_warnings`, must not be `None`")  # noqa: E501
        allowed_values = ["PACKET_LOSS", "LATENCY", "HANDSHAKE"]  # noqa: E501
        if not set(sdn1_warnings).issubset(set(allowed_values)):
            raise ValueError(
                "Invalid values for `sdn1_warnings` [{0}], must be a subset of [{1}]"  # noqa: E501
                .format(", ".join(map(str, set(sdn1_warnings) - set(allowed_values))),  # noqa: E501
                        ", ".join(map(str, allowed_values)))
            )
    ...
    def sdn2_last_handshake(self, sdn2_last_handshake):
        ...
        if sdn2_last_handshake is None:
            raise ValueError("Invalid value for `sdn2_last_handshake`, must not be `None`")  # noqa: E501
    ...
    def sdn2_latency(self, sdn2_latency):
        ...
        if sdn2_latency is None:
            raise ValueError("Invalid value for `sdn2_latency`, must not be `None`")  # noqa: E501
    ...
    def sdn2_packet_loss(self, sdn2_packet_loss):
        ...
        if sdn2_packet_loss is None:
            raise ValueError("Invalid value for `sdn2_packet_loss`, must not be `None`")  # noqa: E501
    ...
    def sdn2_path(self, sdn2_path):
        ...
        if sdn2_path is None:
            raise ValueError("Invalid value for `sdn2_path`, must not be `None`")  # noqa: E501
    ...
    def sdn2_status(self, sdn2_status):
        ...
        if sdn2_status is None:
            raise ValueError("Invalid value for `sdn2_status`, must not be `None`")  # noqa: E501
        allowed_values = ["OK", "WARNING", "ERROR"]  # noqa: E501
        if sdn2_status not in allowed_values:
            raise ValueError(
                "Invalid value for `sdn2_status` ({0}), must be one of {1}"  # noqa: E501
                .format(sdn2_status, allowed_values)
            )
    ...
    def sdn2_warnings(self, sdn2_warnings):
        ...
        if sdn2_warnings is None:
            raise ValueError("Invalid value for `sdn2_warnings`, must not be `None`")  # noqa: E501
        allowed_values = ["PACKET_LOSS", "LATENCY", "HANDSHAKE"]  # noqa: E501
        if not set(sdn2_warnings).issubset(set(allowed_values)):
            raise ValueError(
                "Invalid values for `sdn2_warnings` [{0}], must be a subset of [{1}]"  # noqa: E501
                .format(", ".join(map(str, set(sdn2_warnings) - set(allowed_values))),  # noqa: E501
                        ", ".join(map(str, allowed_values)))
            )
    ...
    def sdn3_last_handshake(self, sdn3_last_handshake):
        ...
        if sdn3_last_handshake is None:
            raise ValueError("Invalid value for `sdn3_last_handshake`, must not be `None`")  # noqa: E501
    ...
    def sdn3_latency(self, sdn3_latency):
        ...
        if sdn3_latency is None:
            raise ValueError("Invalid value for `sdn3_latency`, must not be `None`")  # noqa: E501
    ...
    def sdn3_packet_loss(self, sdn3_packet_loss):
        ...
        if sdn3_packet_loss is None:
            raise ValueError("Invalid value for `sdn3_packet_loss`, must not be `None`")  # noqa: E501
    ...
    def sdn3_path(self, sdn3_path):
        ...
        if sdn3_path is None:
            raise ValueError("Invalid value for `sdn3_path`, must not be `None`")  # noqa: E501
    ...
    def sdn3_status(self, sdn3_status):
        ...
        if sdn3_status is None:
            raise ValueError("Invalid value for `sdn3_status`, must not be `None`")  # noqa: E501
        allowed_values = ["OK", "WARNING", "ERROR"]  # noqa: E501
        if sdn3_status not in allowed_values:
            raise ValueError(
                "Invalid value for `sdn3_status` ({0}), must be one of {1}"  # noqa: E501
                .format(sdn3_status, allowed_values)
            )
    ...
    def sdn3_warnings(self, sdn3_warnings):
        ...
        if sdn3_warnings is None:
            raise ValueError("Invalid value for `sdn3_warnings`, must not be `None`")  # noqa: E501
        allowed_values = ["PACKET_LOSS", "LATENCY", "HANDSHAKE"]  # noqa: E501
        if not set(sdn3_warnings).issubset(set(allowed_values)):
            raise ValueError(
                "Invalid values for `sdn3_warnings` [{0}], must be a subset of [{1}]"  # noqa: E501
                .format(", ".join(map(str, set(sdn3_warnings) - set(allowed_values))),  # noqa: E501
                        ", ".join(map(str, allowed_values)))
            )
