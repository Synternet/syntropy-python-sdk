...
class V1NetworkAgentsLogsSearchRequest(object):
    ...
    def __init__(self, message=None, agent_id=None, severity=None, range_from=None, range_to=None, sort=None, _from=None, size=None):  # noqa: E501
    ...
    def range_from(self, range_from):
        ...
        if range_from is None:
            raise ValueError("Invalid value for `range_from`, must not be `None`")  # noqa: E501
    ...
    def range_to(self, range_to):
        ...
        """
        if range_to is None:
            raise ValueError("Invalid value for `range_to`, must not be `None`")  # noqa: E501
