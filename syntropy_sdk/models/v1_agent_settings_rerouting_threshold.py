...
class V1AgentSettingsReroutingThreshold(object):
    ...
    def __init__(self, default=None, latency_ratio_default=None, latency_diff_default=None, latency_ratio=None, latency_diff=None):  # noqa: E501
    ...
    def latency_ratio_default(self, latency_ratio_default):
        ...
        if latency_ratio_default is None:
            raise ValueError("Invalid value for `latency_ratio_default`, must not be `None`")  # noqa: E501
    ...
    def latency_diff_default(self, latency_diff_default):
        ...
        if latency_diff_default is None:
            raise ValueError("Invalid value for `latency_diff_default`, must not be `None`")  # noqa: E501
