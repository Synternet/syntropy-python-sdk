...
class V1AuthApiKey(object):
    ...
    def __init__(self, api_key_name=None, api_key_description=None, api_key_valid_until=None, api_key_status=None, api_key_id=None, api_key_created_at=None, api_key_updated_at=None):  # noqa: E501
    ...
    def api_key_description(self, api_key_description):
        ...
        if api_key_description is None:
            raise ValueError("Invalid value for `api_key_description`, must not be `None`")  # noqa: E501
    ...
    def api_key_valid_until(self, api_key_valid_until):
        ...
        if api_key_valid_until is None:
            raise ValueError("Invalid value for `api_key_valid_until`, must not be `None`")  # noqa: E501
    ...
    def api_key_created_at(self, api_key_created_at):
        ...
        if api_key_created_at is None:
            raise ValueError("Invalid value for `api_key_created_at`, must not be `None`")  # noqa: E501
    ...
    def api_key_updated_at(self, api_key_updated_at):
        ...
        if api_key_updated_at is None:
            raise ValueError("Invalid value for `api_key_updated_at`, must not be `None`")  # noqa: E501
