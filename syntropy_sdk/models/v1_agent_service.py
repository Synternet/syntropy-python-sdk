...
class V1AgentService(object):
    ...
    def __init__(self, agent_service_name=None, agent_service_type=None, agent_service_networks=None, agent_service_tcp_ports=None, agent_service_udp_ports=None, agent_service_is_active=None, agent_service_created_at=None, agent_service_subnets=None):  # noqa: E501
    ...
    def agent_service_networks(self, agent_service_networks):
        ...
        if agent_service_networks is None:
            raise ValueError("Invalid value for `agent_service_networks`, must not be `None`")  # noqa: E501
