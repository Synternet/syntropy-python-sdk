...
class V1NetworkAuditSearchRequest(object):
    ...
    def __init__(self, action=None, _from=None, performed_by=None, skip=None, source=None, take=None, to=None, type=None):  # noqa: E501
    ...
    def action(self, action):
        ...
        :type: list[str]
        """
        allowed_values = ["ACTION_CREATED", "ACTION_DELETED", "ACTION_UPDATED"]  # noqa: E501
    ...
    def source(self, source):
        ...
        if not set(source).issubset(set(allowed_values)):
            raise ValueError(
                "Invalid values for `source` [{0}], must be a subset of [{1}]"  # noqa: E501
                .format(", ".join(map(str, set(source) - set(allowed_values))),  # noqa: E501
                        ", ".join(map(str, allowed_values)))
            )
    ...
    def type(self, type):
        ...
        :type: list[str]
        """
        allowed_values = ["TYPE_ACCESS_TOKEN", "TYPE_AGENT_TOKEN", "TYPE_AGENT", "TYPE_CONNECTION"]  # noqa: E501
