...
class V1NetworkConnectionsServicesRemoveRequest(object):
    ...
    """
    swagger_types = {"agent_connection_subnet_ids": "list[IdNumber]"}

    attribute_map = {"agent_connection_subnet_ids": "agent_connection_subnet_ids"}
    ...
    def agent_connection_subnet_ids(self, agent_connection_subnet_ids):
        ...
        if agent_connection_subnet_ids is None:
            raise ValueError(
                "Invalid value for `agent_connection_subnet_ids`, must not be `None`"
            )  # noqa: E501
