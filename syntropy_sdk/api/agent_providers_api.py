...
class AgentProvidersApi(object):
    ...
    def create_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type="AgentProviderObject",  # noqa: E501
    ...
    def destroy(self, id, **kwargs):  # noqa: E501
        """destroy  # noqa: E501
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.destroy_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.destroy_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def destroy_with_http_info(self, id, **kwargs):  # noqa: E501
        """destroy  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.destroy_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'" " to method destroy" % key
                )
            params[key] = val
        del params["kwargs"]
        ...
        if "id" not in params or params["id"] is None:
            raise ValueError(
                "Missing the required parameter `id` when calling `destroy`"
            )  # noqa: E501
    ...
    def index(self, **kwargs):  # noqa: E501
        ...
        :param str order:
        :param str filter:
        :return: list[AgentProviderObject]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs["_return_http_data_only"] = True
    ...
    def index_with_http_info(self, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'" " to method index" % key
                )
            params[key] = val
        del params["kwargs"]
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type="list[AgentProviderObject]",  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get("async_req"),
            _return_http_data_only=params.get("_return_http_data_only"),
            _preload_content=params.get("_preload_content", True),
    ...
    def show(self, id, **kwargs):  # noqa: E501
        """show  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.show(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.show_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.show_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def show_with_http_info(self, id, **kwargs):  # noqa: E501
        """show  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.show_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'" " to method show" % key
                )
            params[key] = val
        del params["kwargs"]
        # verify the required parameter 'id' is set
    ...
    def update(self, body, id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param TsoaPartialAgentProviderObject_ body: (required)
        :param float id: (required)
        :return: AgentProviderObject
                 If the method is called asynchronously,
                 returns the request thread.
