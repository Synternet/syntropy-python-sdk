...
class PlatformApi(object):
    ...
    def delete_agent_services(self, body, **kwargs):  # noqa: E501
        """delete_agent_services  # noqa: E501

        Deletes agent Services  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_agent_services(body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.delete_agent_services_with_http_info(
                body, **kwargs
            )  # noqa: E501
        else:
            (data) = self.delete_agent_services_with_http_info(
                body, **kwargs
            )  # noqa: E501
            return data

    def delete_agent_services_with_http_info(self, body, **kwargs):  # noqa: E501
        """delete_agent_services  # noqa: E501

        Deletes agent Services  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_agent_services_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_agent_services" % key
                )
            params[key] = val
        del params["kwargs"]
        # verify the required parameter 'body' is set
        if "body" not in params or params["body"] is None:
            raise ValueError(
                "Missing the required parameter `body` when calling `delete_agent_services`"
            )  # noqa: E501
    ...
    def delete_connection_subnets(self, body, **kwargs):  # noqa: E501
        """delete_connection_subnets  # noqa: E501

        Deletes agent connection services/subnets  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_connection_subnets(body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.delete_connection_subnets_with_http_info(
                body, **kwargs
            )  # noqa: E501
        else:
            (data) = self.delete_connection_subnets_with_http_info(
                body, **kwargs
            )  # noqa: E501
            return data

    def delete_connection_subnets_with_http_info(self, body, **kwargs):  # noqa: E501
        """delete_connection_subnets  # noqa: E501

        Deletes agent connection services/subnets  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_connection_subnets_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_connection_subnets" % key
                )
            params[key] = val
        del params["kwargs"]
        # verify the required parameter 'body' is set
        if "body" not in params or params["body"] is None:
            raise ValueError(
                "Missing the required parameter `body` when calling `delete_connection_subnets`"
            )  # noqa: E501
