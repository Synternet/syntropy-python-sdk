...
class RulesApi(object):
    ...
    def connection_point_to_tag_create_with_http_info(
        ...
        if "body" not in params or params["body"] is None:
            raise ValueError(
                "Missing the required parameter `body` when calling `rules_connection_point_to_tag_create`"
            )  # noqa: E501
    ...
    def connection_point_to_tag_remove_with_http_info(
        ...
        if "body" not in params or params["body"] is None:
            raise ValueError(
                "Missing the required parameter `body` when calling `rules_connection_point_to_tag_remove`"
            )  # noqa: E501
    ...
    def connection_point_to_tag_search_with_http_info(
        ...
        if "body" not in params or params["body"] is None:
            raise ValueError(
                "Missing the required parameter `body` when calling `rules_connection_point_to_tag_search`"
            )  # noqa: E501
    ...
    def connection_point_to_tag_show_by_id_with_http_info(
        ...
        if "agent_id" not in params or params["agent_id"] is None:
            raise ValueError(
                "Missing the required parameter `agent_id` when calling `rules_connection_point_to_tag_show_by_id`"
            )  # noqa: E501
